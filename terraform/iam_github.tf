...
resource "google_iam_workload_identity_pool_provider" "github" {
  ...
  attribute_condition = "attribute.repository == \"wizzi7/trip-planner\""
...
resource "google_service_account_iam_member" "github_actions_impersonation" {
  ...
  member             = "principalSet://iam.googleapis.com/${google_iam_workload_identity_pool.github.name}/attribute.repository/wizzi7/trip-planner"
}
