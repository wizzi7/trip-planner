...
class AttractionsAgent(BaseAgent):
    ...
    def _build_system_prompt(self):
        return (
            ...
            "For full days, plan MINIMUM 10 attractions. Do NOT exceed 10 attractions per day. "
            ...
            "Prioritize the most iconic and must-see attractions first, then fill remaining slots with lesser-known gems. "
